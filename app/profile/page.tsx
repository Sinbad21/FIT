...
import { MascotPicker } from '@/components/mascots/MascotPicker';
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="grid grid-cols-2 gap-2">
        <Link href="/settings/ai" className="min-h-11 rounded-2xl bg-gray-950 px-3 text-center font-black leading-[2.75rem] text-white">Assistente AI</Link>
