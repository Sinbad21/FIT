    ...
    <div>
      ...
      <div className="glass-card space-y-4 rounded-[1.6rem] p-5">
        ...
        <label className="block"><span className="text-sm font-black">Livello</span>
          <select value={form.level} onChange={(e) => set('level', e.target.value)} className="mt-2 min-h-12 w-full rounded-2xl border border-slate-200 px-4">
        ...
        <label className="block"><span className="text-sm font-black">Attrezzatura</span>
          <select value={form.equipment} onChange={(e) => set('equipment', e.target.value)} className="mt-2 min-h-12 w-full rounded-2xl border border-slate-200 px-4">
