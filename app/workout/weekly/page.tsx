...
export default function WeeklyWorkoutPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <PlanSelector />
      {plan ? <Link href="/workout/print" className="inline-block min-h-11 rounded-2xl bg-cyan-500 px-4 font-black leading-[2.75rem] text-white">Scarica / Stampa scheda (PDF)</Link> : null}
