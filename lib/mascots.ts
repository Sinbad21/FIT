...
export type MascotId = 'black-cat' | 'stickman' | 'fox' | 'anime';
...
export const MASCOTS: MascotDef[] = [
  { id: 'black-cat', name: 'Notte', description: 'Gatta nera, pigra ma sveglia', rivSrc: '/mascots/black-cat.riv', stateMachine: 'Mascot', accent: '#22c55e' },
  { id: 'stickman', name: 'Stick', description: 'Stickman, pura energia', rivSrc: '/mascots/stickman.riv', stateMachine: 'Mascot', accent: '#2563eb' },
  { id: 'fox', name: 'Kira', description: 'Volpe furba e scattante', rivSrc: '/mascots/fox.riv', stateMachine: 'Mascot', accent: '#f97316' },
  { id: 'anime', name: 'Yui', description: 'Coach in stile anime', rivSrc: '/mascots/anime.riv', stateMachine: 'Mascot', accent: '#ec4899' },
];
